  ...
  return (
    <>
      <CalculatorSearch 
        ...
        placeholder={t('constructionCalculators.searchPlaceholder') || 'Search calculators...'}
        resultsText={t('constructionCalculators.resultsFound') || 'results found'}
        noResultsText={t('constructionCalculators.noResults') || 'No results found'}
        noResultsHint={t('constructionCalculators.tryDifferentSearch') || 'Try a different search term'}
      />
      ...
      <div className="calculators-list">
        ...
        {filteredCalculators.length === 0 && (
          <div className="no-results">
            ...
            <p className="no-results-text">{t('constructionCalculators.noResults') || 'No results found'}</p>
            <p className="no-results-hint">{t('constructionCalculators.tryDifferentSearch') || 'Try a different search term'}</p>
          </div>
        )}
      </div>
    </>
