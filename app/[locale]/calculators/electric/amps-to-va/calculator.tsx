...
export function ampToVa(amps: number, volts: number, phase: PhaseType): number {
  if (amps <= 0 || volts <= 0) return 0;
  if (phase === 'three') return Math.sqrt(3) * amps * volts;
  return amps * volts;
}

export function AmpToVaCalculator() {
  const t = useTranslations('calculators.ampToVa');
        ...
        <div ref={resultRef} className="result-section">
          ...
          <div className="result-display">
            <div className="result-item">
              <div className="result-label">VA</div>
