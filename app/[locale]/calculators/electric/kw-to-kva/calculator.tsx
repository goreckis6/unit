...
/** kVA = kW / PF; apparent power from real power and power factor */
export function kwToKva(kw: number, powerFactor: number): number {
  if (powerFactor <= 0 || powerFactor > 1) return 0;
  return kw / powerFactor;
}

export function KwToKvaCalculator() {
  const t = useTranslations('calculators.kwToKva');
