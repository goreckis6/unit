  ...
  return (
    <>
      <CalculatorSearch 
        ...
        placeholder={t('electricCalculators.searchPlaceholder') || 'Search calculators...'}
        resultsText={t('electricCalculators.resultsFound') || 'results found'}
        noResultsText={t('electricCalculators.noResults') || 'No results found'}
        noResultsHint={t('electricCalculators.tryDifferentSearch') || 'Try a different search term'}
      />
      ...
      <div className="calculators-list">
        ...
        {filteredCalculators.length === 0 && (
          <div className="no-results">
            ...
            <p className="no-results-text">{t('electricCalculators.noResults') || 'No results found'}</p>
            <p className="no-results-hint">{t('electricCalculators.tryDifferentSearch') || 'Try a different search term'}</p>
          </div>
        )}
      </div>
    </>
