...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const baseUrl = 'https://unitconverterhub.com';
  const path = locale === 'en' ? '/calculators/others/italic-text' : `/${locale}/calculators/others/italic-text`;
  const canonicalUrl = `${baseUrl}${path}`;
  const hreflangUrls = generateHreflangUrls('/calculators/others/italic-text');
