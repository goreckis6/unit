...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const baseUrl = 'https://unitconverterhub.com';
  const path = locale === 'en' ? '/calculators/others/upside-down-text' : `/${locale}/calculators/others/upside-down-text`;
  const canonicalUrl = `${baseUrl}${path}`;
  const hreflangUrls = generateHreflangUrls('/calculators/others/upside-down-text');
