  ...
  return (
    <>
      <CalculatorSearch 
        ...
        placeholder={t('physicsCalculators.searchPlaceholder') || 'Search calculators...'}
        resultsText={t('physicsCalculators.resultsFound') || 'results found'}
        noResultsText={t('physicsCalculators.noResults') || 'No results found'}
        noResultsHint={t('physicsCalculators.tryDifferentSearch') || 'Try a different search term'}
      />
      ...
      <div className="calculators-list">
        ...
        {filteredCalculators.length === 0 && (
          <div className="no-results">
            ...
            <p className="no-results-text">{t('physicsCalculators.noResults') || 'No results found'}</p>
            <p className="no-results-hint">{t('physicsCalculators.tryDifferentSearch') || 'Try a different search term'}</p>
          </div>
        )}
      </div>
    </>
