  ...
  return (
    <>
      <CalculatorSearch
        ...
        placeholder={t('realLifeCalculators.searchPlaceholder') || 'Search calculators...'}
        resultsText={t('realLifeCalculators.resultsFound') || 'results found'}
        noResultsText={t('realLifeCalculators.noResults') || 'No results found'}
        noResultsHint={t('realLifeCalculators.tryDifferentSearch') || 'Try a different search term'}
      />
      ...
      <div className="calculators-list">
        ...
        {filteredCalculators.length === 0 && (
          <div className="no-results">
            ...
            <p className="no-results-text">{t('realLifeCalculators.noResults') || 'No results found'}</p>
            <p className="no-results-hint">{t('realLifeCalculators.tryDifferentSearch') || 'Try a different search term'}</p>
          </div>
        )}
      </div>
    </>
