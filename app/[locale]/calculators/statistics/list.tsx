  ...
  return (
    <>
      <CalculatorSearch 
        ...
        placeholder={t('statisticsCalculators.searchPlaceholder') || 'Search calculators...'}
        resultsText={t('statisticsCalculators.resultsFound') || 'results found'}
        noResultsText={t('statisticsCalculators.noResults') || 'No results found'}
        noResultsHint={t('statisticsCalculators.tryDifferentSearch') || 'Try a different search term'}
      />
      ...
      <div className="calculators-list">
        ...
        {filteredCalculators.length === 0 && (
          <div className="no-results">
            ...
            <p className="no-results-text">{t('statisticsCalculators.noResults') || 'No results found'}</p>
            <p className="no-results-hint">{t('statisticsCalculators.tryDifferentSearch') || 'Try a different search term'}</p>
          </div>
        )}
      </div>
    </>
