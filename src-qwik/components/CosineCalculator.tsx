      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.cosine-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.cosine-calculator.title')}</h1>
            <p class="page-description">{t('calculators.cosine-calculator.description')}</p>
          </div>
        </div>
