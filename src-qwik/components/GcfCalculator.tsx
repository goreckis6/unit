      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.gcf-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.gcf-calculator.title')}</h1>
            <p class="page-description">{t('calculators.gcf-calculator.description')}</p>
          </div>
        </div>
