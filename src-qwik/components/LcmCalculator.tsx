      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.lcm-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.lcm-calculator.title')}</h1>
            <p class="page-description">{t('calculators.lcm-calculator.description')}</p>
          </div>
        </div>
