      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.percent-error-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.percent-error-calculator.title')}</h1>
            <p class="page-description">{t('calculators.percent-error-calculator.description')}</p>
          </div>
        </div>
