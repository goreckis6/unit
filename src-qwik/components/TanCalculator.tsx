      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.tan-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.tan-calculator.title')}</h1>
            <p class="page-description">{t('calculators.tan-calculator.description')}</p>
          </div>
        </div>
