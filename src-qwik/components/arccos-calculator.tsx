      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.arccos-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.arccos-calculator.title')}</h1>
            <p class="page-description">{t('calculators.arccos-calculator.description')}</p>
          </div>
        </div>
