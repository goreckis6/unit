      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.arcsin-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.arcsin-calculator.title')}</h1>
            <p class="page-description">{t('calculators.arcsin-calculator.description')}</p>
          </div>
        </div>
