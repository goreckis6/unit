      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.arctan-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.arctan-calculator.title')}</h1>
            <p class="page-description">{t('calculators.arctan-calculator.description')}</p>
          </div>
        </div>
