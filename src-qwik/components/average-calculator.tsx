      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.average-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.average-calculator.title')}</h1>
            <p class="page-description">{t('calculators.average-calculator.description')}</p>
          </div>
        </div>
