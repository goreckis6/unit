      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.exponent-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.exponent-calculator.title')}</h1>
            <p class="page-description">{t('calculators.exponent-calculator.description')}</p>
          </div>
        </div>
