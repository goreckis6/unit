      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.factorial-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.factorial-calculator.title')}</h1>
            <p class="page-description">{t('calculators.factorial-calculator.description')}</p>
          </div>
        </div>
