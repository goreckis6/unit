      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.multiplying-fractions.badge')}</div>
            <h1 class="page-title">{t('calculators.multiplying-fractions.title')}</h1>
            <p class="page-description">{t('calculators.multiplying-fractions.description')}</p>
          </div>
        </div>
