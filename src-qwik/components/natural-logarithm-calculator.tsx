      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.natural-logarithm-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.natural-logarithm-calculator.title')}</h1>
            <p class="page-description">{t('calculators.natural-logarithm-calculator.description')}</p>
          </div>
        </div>
