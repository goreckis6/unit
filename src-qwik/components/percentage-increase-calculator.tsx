      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.percentage-increase-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.percentage-increase-calculator.title')}</h1>
            <p class="page-description">{t('calculators.percentage-increase-calculator.description')}</p>
          </div>
        </div>
