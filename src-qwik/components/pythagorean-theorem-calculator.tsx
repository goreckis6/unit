      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.pythagorean-theorem-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.pythagorean-theorem-calculator.title')}</h1>
            <p class="page-description">{t('calculators.pythagorean-theorem-calculator.description')}</p>
          </div>
        </div>
