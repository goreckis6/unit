      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.quadratic-equation-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.quadratic-equation-calculator.title')}</h1>
            <p class="page-description">{t('calculators.quadratic-equation-calculator.description')}</p>
          </div>
        </div>
