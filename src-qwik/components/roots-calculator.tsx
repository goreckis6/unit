      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.roots-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.roots-calculator.title')}</h1>
            <p class="page-description">{t('calculators.roots-calculator.description')}</p>
          </div>
        </div>
