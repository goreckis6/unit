      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.sin-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.sin-calculator.title')}</h1>
            <p class="page-description">{t('calculators.sin-calculator.description')}</p>
          </div>
        </div>
