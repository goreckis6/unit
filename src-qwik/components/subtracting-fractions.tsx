      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.subtracting-fractions.badge')}</div>
            <h1 class="page-title">{t('calculators.subtracting-fractions.title')}</h1>
            <p class="page-description">{t('calculators.subtracting-fractions.description')}</p>
          </div>
        </div>
