...
export default component$(() => {
  ...
  const calculatorName = t('calculators.adding-fractions-calculator.title');
  const calculatorDescription = t('calculators.adding-fractions-calculator.seo.description');
