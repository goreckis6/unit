...
export default component$(() => {
  ...
  const calculatorName = t('calculators.amps-to-kva-calculator.title');
  const calculatorDescription = t('calculators.amps-to-kva-calculator.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.amps-to-kva-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.amps-to-kva-calculator.title')}</h1>
            <p class="page-description">{t('calculators.amps-to-kva-calculator.description')}</p>
          </div>
        </div>
