...
export default component$(() => {
  ...
  const calculatorName = t('calculators.amps-to-va-calculator.title');
  const calculatorDescription = t('calculators.amps-to-va-calculator.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.amps-to-va-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.amps-to-va-calculator.title')}</h1>
            <p class="page-description">{t('calculators.amps-to-va-calculator.description')}</p>
          </div>
        </div>
