...
export default component$(() => {
  ...
  const calculatorName = t('calculators.amps-to-volts-calculator.title');
  const calculatorDescription = t('calculators.amps-to-volts-calculator.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.amps-to-volts-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.amps-to-volts-calculator.title')}</h1>
            <p class="page-description">{t('calculators.amps-to-volts-calculator.description')}</p>
          </div>
        </div>
