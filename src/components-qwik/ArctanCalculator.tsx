...
export default component$(() => {
  ...
  const validateInput = $(() => {
    ...
    if (inputValue.value !== null && (inputValue.value < -1 || inputValue.value > 1)) {
      error.value = t('calculators.arctan.error.invalidRange');
    }
  });
  ...
  const calculate = $(() => {
    ...
    if (inputValue.value === null || inputValue.value === '') {
      error.value = t('calculators.arctan.error.invalidInput');
      return;
    }
    ...
    // Arctan: Math.atan(x) returns result in radians
    const angleInRadians = Math.atan(inputValue.value);
  ...
  const calculatorName = t('calculators.arctan.title');
  const calculatorDescription = t('calculators.arctan.seo.description');
                ...
                <div class="result-display">
                  <div class="sin-result">
                    <div class="result-formula">
                      <span class="formula-text">
                        arctan({inputValue.value}) = {formatResult(result.value)}{angleMode.value === 'degrees' ? '°' : ' rad'}
                      </span>
                    </div>
                  ...
                  {angleInfo.value && (
                    <div class="angle-info-box">
                      <div class="info-row">
                        <span class="info-label">{t('calculators.arctan.angle')}:</span>
                        <span class="info-value">{angleInfo.value.angleDegrees.toFixed(2)}°</span>
                      </div>
                      <div class="info-row">
                        <span class="info-label">{t('calculators.arctan.radians')}:</span>
                ...
                {result.value !== null && (
                  <div class="info-section">
                    <div class="info-card">
                      ...
                      <div class="info-item">
                        <span class="info-label">{t('calculators.arctan.resultValue')}:</span>
...
export const head: DocumentHead = ({ resolveValue }) => {
  ...
  return {
    title: t('calculators.arctan.seo.title'),
    meta: [
      {
        name: 'description',
        content: t('calculators.arctan.seo.description'),
      },
      {
        name: 'keywords',
        content: t('calculators.arctan.seo.keywords'),
      },
    ],
  };
};
