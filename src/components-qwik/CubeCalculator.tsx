...
export default component$(() => {
  ...
  const calculatorName = t('calculators.cube.title');
  const calculatorDescription = t('calculators.cube.seo.description');
...
export const head: DocumentHead = {
  title: 'Cube Calculator - Free Online Math Tool | Unit Converter Hub',
  meta: [
    {
      name: 'description',
      content: 'Free online cube calculator. Calculate the cube of a number instantly and accurately.',
    },
    {
      name: 'keywords',
      content: 'cube calculator, cube number, math calculator',
    },
  ],
};
