...
export default component$(() => {
  ...
  const calculatorName = t('calculators.dividing-fractions-calculator.title');
  const calculatorDescription = t('calculators.dividing-fractions-calculator.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.dividing-fractions-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.dividing-fractions-calculator.title')}</h1>
            <p class="page-description">{t('calculators.dividing-fractions-calculator.description')}</p>
          </div>
        </div>
