...
export default component$(() => {
  ...
  const calculate = $(() => {
    ...
    if (num2 === 0) {
      errorMessage.value = t('calculators.division.error.divisionByZero');
      result.value = null;
      return;
    }
  ...
  const calculatorName = t('calculators.division.title');
  const calculatorDescription = t('calculators.division.seo.description');
...
export const head: DocumentHead = {
  title: 'Division Calculator - Free Online Math Tool | Unit Converter Hub',
  meta: [
    {
      name: 'description',
      content: 'Free online division calculator. Divide two numbers instantly and accurately.',
    },
    {
      name: 'keywords',
      content: 'division calculator, divide numbers, math calculator',
    },
  ],
};
