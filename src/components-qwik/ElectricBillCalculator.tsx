...
export default component$(() => {
  ...
  const calculatorName = t('calculators.electric-bill-calculator.title');
  const calculatorDescription = t('calculators.electric-bill-calculator.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.electric-bill-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.electric-bill-calculator.title')}</h1>
            <p class="page-description">{t('calculators.electric-bill-calculator.description')}</p>
          </div>
        </div>
