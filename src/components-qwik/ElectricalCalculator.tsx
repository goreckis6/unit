      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.electrical-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.electrical-calculator.title')}</h1>
            <p class="page-description">{t('calculators.electrical-calculator.description')}</p>
          </div>
        </div>
