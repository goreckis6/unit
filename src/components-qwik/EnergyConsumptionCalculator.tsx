...
export default component$(() => {
  ...
  const calculatorName = t('calculators.energy-consumption-calculator.title');
  const calculatorDescription = t('calculators.energy-consumption-calculator.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.energy-consumption-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.energy-consumption-calculator.title')}</h1>
            <p class="page-description">{t('calculators.energy-consumption-calculator.description')}</p>
          </div>
        </div>
