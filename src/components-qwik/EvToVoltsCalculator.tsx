...
export default component$(() => {
  ...
  const calculatorName = t('calculators.ev-to-volts.title');
  const calculatorDescription = t('calculators.ev-to-volts.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.ev-to-volts-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.ev-to-volts-calculator.title')}</h1>
            <p class="page-description">{t('calculators.ev-to-volts-calculator.description')}</p>
          </div>
        </div>
