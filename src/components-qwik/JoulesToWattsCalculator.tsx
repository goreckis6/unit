...
export default component$(() => {
  ...
  const calculatorName = t('calculators.joules-to-watts.title');
  const calculatorDescription = t('calculators.joules-to-watts.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.joules-to-watts-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.joules-to-watts-calculator.title')}</h1>
            <p class="page-description">{t('calculators.joules-to-watts-calculator.description')}</p>
          </div>
        </div>
