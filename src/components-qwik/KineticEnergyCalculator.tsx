...
export default component$(() => {
  ...
  const calculatorName = t('calculators.kinetic-energy-calculator.title');
  const calculatorDescription = t('calculators.kinetic-energy-calculator.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.kinetic-energy-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.kinetic-energy-calculator.title')}</h1>
            <p class="page-description">{t('calculators.kinetic-energy-calculator.description')}</p>
          </div>
        </div>
