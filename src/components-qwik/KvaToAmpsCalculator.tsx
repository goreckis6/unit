...
export default component$(() => {
  ...
  const calculatorName = t('calculators.kva-to-amps.title');
  const calculatorDescription = t('calculators.kva-to-amps.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.kva-to-amps-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.kva-to-amps-calculator.title')}</h1>
            <p class="page-description">{t('calculators.kva-to-amps-calculator.description')}</p>
          </div>
        </div>
