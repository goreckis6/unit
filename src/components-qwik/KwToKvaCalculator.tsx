...
export default component$(() => {
  ...
  const calculatorName = t('calculators.kw-to-kva.title');
  const calculatorDescription = t('calculators.kw-to-kva.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.kw-to-kva-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.kw-to-kva-calculator.title')}</h1>
            <p class="page-description">{t('calculators.kw-to-kva-calculator.description')}</p>
          </div>
        </div>
