...
export default component$(() => {
  ...
  const calculatorName = t('calculators.kw-to-volts.title');
  const calculatorDescription = t('calculators.kw-to-volts.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.kw-to-volts-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.kw-to-volts-calculator.title')}</h1>
            <p class="page-description">{t('calculators.kw-to-volts-calculator.description')}</p>
          </div>
        </div>
