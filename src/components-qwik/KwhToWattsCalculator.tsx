...
export default component$(() => {
  ...
  const calculatorName = t('calculators.kwh-to-watts.title');
  const calculatorDescription = t('calculators.kwh-to-watts.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.kwh-to-watts-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.kwh-to-watts-calculator.title')}</h1>
            <p class="page-description">{t('calculators.kwh-to-watts-calculator.description')}</p>
          </div>
        </div>
