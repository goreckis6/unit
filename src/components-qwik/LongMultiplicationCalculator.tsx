...
export default component$(() => {
  ...
  const calculate = $(() => {
    ...
    if (isNaN(a) || isNaN(b)) {
      error.value = t('calculators.longMultiplication.error.invalidInput');
      return;
    }
    ...
    try {
      ...
      if (!isFinite(calculated)) {
        error.value = t('calculators.longMultiplication.error.invalidResult');
        return;
      }
      
      result.value = calculated;
    } catch (e) {
      error.value = t('calculators.longMultiplication.error.calculationError');
    }
  });
  ...
  const calculatorName = t('calculators.long-multiplication.title');
  const calculatorDescription = t('calculators.long-multiplication.seo.description');
              ...
              <div class="addition-row">
                <div class="number-card">
                  <div class="number-card-header">
                    ...
                    <label class="number-label">{t('calculators.longMultiplication.firstNumber')}</label>
                  </div>
                  <input
                    type="number"
                    class="number-input-large"
                    placeholder={t('calculators.longMultiplication.enterFirstNumber')}
                ...
                <div class="number-card">
                  <div class="number-card-header">
                    <div class="number-badge">×</div>
                    <label class="number-label">{t('calculators.longMultiplication.secondNumber')}</label>
                  </div>
                  <input
                    type="number"
                    class="number-input-large"
                    placeholder={t('calculators.longMultiplication.enterSecondNumber')}
...
export const head: DocumentHead = ({ resolveValue }) => {
  ...
  return {
    title: t('calculators.longMultiplication.seo.title'),
    meta: [
      {
        name: 'description',
        content: t('calculators.longMultiplication.seo.description'),
      },
      {
        name: 'keywords',
        content: t('calculators.longMultiplication.seo.keywords'),
      },
    ],
  };
};
