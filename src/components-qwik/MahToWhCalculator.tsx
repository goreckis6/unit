...
export default component$(() => {
  ...
  const calculatorName = t('calculators.mah-to-wh.title');
  const calculatorDescription = t('calculators.mah-to-wh.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.mah-to-wh-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.mah-to-wh-calculator.title')}</h1>
            <p class="page-description">{t('calculators.mah-to-wh-calculator.description')}</p>
          </div>
        </div>
