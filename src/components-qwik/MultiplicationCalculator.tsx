...
export default component$(() => {
  ...
  const calculatorName = t('calculators.multiplication.title');
  const calculatorDescription = t('calculators.multiplication.seo.description');
...
export const head: DocumentHead = {
  title: 'Multiplication Calculator - Free Online Math Tool | Unit Converter Hub',
  meta: [
    {
      name: 'description',
      content: 'Free online multiplication calculator. Multiply two numbers instantly and accurately.',
    },
    {
      name: 'keywords',
      content: 'multiplication calculator, multiply numbers, math calculator',
    },
  ],
};
