...
export default component$(() => {
  ...
  const calculatorName = t('calculators.ohms-law-calculator.title');
  const calculatorDescription = t('calculators.ohms-law-calculator.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.ohms-law-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.ohms-law-calculator.title')}</h1>
            <p class="page-description">{t('calculators.ohms-law-calculator.description')}</p>
          </div>
        </div>
