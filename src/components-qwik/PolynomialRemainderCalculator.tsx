...
export default component$(() => {
  ...
  const calculatorName = t('calculators.polynomial-remainder-calculator.title');
  const calculatorDescription = t('calculators.polynomial-remainder-calculator.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.polynomial-remainder-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.polynomial-remainder-calculator.title')}</h1>
            <p class="page-description">{t('calculators.polynomial-remainder-calculator.description')}</p>
          </div>
        </div>
