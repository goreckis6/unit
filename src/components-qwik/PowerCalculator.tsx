...
export default component$(() => {
  ...
  const calculatorName = t('calculators.power-calculator.title');
  const calculatorDescription = t('calculators.power-calculator.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.power-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.power-calculator.title')}</h1>
            <p class="page-description">{t('calculators.power-calculator.description')}</p>
          </div>
        </div>
