      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.random-numbers-generator.badge')}</div>
            <h1 class="page-title">{t('calculators.random-numbers-generator.title')}</h1>
            <p class="page-description">{t('calculators.random-numbers-generator.description')}</p>
          </div>
        </div>
