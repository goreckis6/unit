...
export default component$(() => {
  ...
  const calculatorName = t('calculators.simplifying-fractions-calculator.title');
  const calculatorDescription = t('calculators.simplifying-fractions-calculator.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.simplifying-fractions-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.simplifying-fractions-calculator.title')}</h1>
            <p class="page-description">{t('calculators.simplifying-fractions-calculator.description')}</p>
          </div>
        </div>
