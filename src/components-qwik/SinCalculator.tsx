...
export default component$(() => {
  ...
  const calculate = $(() => {
    ...
    if (inputValue.value === null || inputValue.value === '') {
      error.value = t('calculators.sin.error.invalidInput');
      return;
    }
    ...
    result.value = Math.sin(angleInRadians);
  });
  ...
  const calculatorName = t('calculators.sin.title');
  const calculatorDescription = t('calculators.sin.seo.description');
