...
export default component$(() => {
  ...
  const validateInput = $(() => {
    ...
    if (inputValue.value !== null && inputValue.value < 0) {
      error.value = t('calculators.squareRoot.error.negativeNumber');
    }
  });
  ...
  const calculate = $(() => {
    ...
    if (inputValue.value === null || inputValue.value === '') {
      error.value = t('calculators.squareRoot.error.invalidInput');
      return;
    }
    ...
    result.value = Math.sqrt(inputValue.value);
  });
  ...
  const calculatorName = t('calculators.squareRoot.title');
  const calculatorDescription = t('calculators.squareRoot.seo.description');
                ...
                <div class="result-display">
                  <div class="square-root-result">
                    <div class="result-formula">
                      <span class="formula-text">√{inputValue.value}</span>
                  ...
                  <div class="info-section">
                    <div class="info-card">
                      ...
                      <div class="info-item">
                        ...
                        <span class="info-value">{inputValue.value}² = {(result.value * result.value).toFixed(2)}</span>
                      </div>
                    </div>
                  </div>
                )}
...
export const head: DocumentHead = ({ resolveValue }) => {
  ...
  return {
    title: t('calculators.squareRoot.seo.title'),
    meta: [
      {
        name: 'description',
        content: t('calculators.squareRoot.seo.description'),
      },
      {
        name: 'keywords',
        content: t('calculators.squareRoot.seo.keywords'),
      },
    ],
  };
};
