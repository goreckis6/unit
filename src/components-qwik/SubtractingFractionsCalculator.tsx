...
export default component$(() => {
  ...
  const calculate = $(() => {
    ...
    if (!canCalculate.value) {
      error.value = t('calculators.subtractingFractions.error.invalidInput');
      return;
    }
    ...
    if (den1 === 0 || den2 === 0) {
      error.value = t('calculators.subtractingFractions.error.zeroDenominator');
      return;
    }
    ...
    try {
      ...
      error.value = t('calculators.subtractingFractions.error.calculationError');
    }
  });
  ...
  const calculatorName = t('calculators.subtractingFractions.title');
  const calculatorDescription = t('calculators.subtractingFractions.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          ...
          <div class="header-content">
            <div class="title-badge">{t('calculators.subtractingFractions.badge')}</div>
...
export const head: DocumentHead = ({ resolveValue }) => {
  ...
  return {
    title: t('calculators.subtractingFractions.seo.title'),
    meta: [
      {
        name: 'description',
        content: t('calculators.subtractingFractions.seo.description'),
      },
      {
        name: 'keywords',
        content: t('calculators.subtractingFractions.seo.keywords'),
      },
    ],
  };
};
