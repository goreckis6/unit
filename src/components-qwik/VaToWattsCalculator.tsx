...
export default component$(() => {
  ...
  const calculatorName = t('calculators.va-to-watts.title');
  const calculatorDescription = t('calculators.va-to-watts.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.va-to-watts-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.va-to-watts-calculator.title')}</h1>
            <p class="page-description">{t('calculators.va-to-watts-calculator.description')}</p>
          </div>
        </div>
