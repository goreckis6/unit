...
export default component$(() => {
  ...
  const calculatorName = t('calculators.voltage-divider-calculator.title');
  const calculatorDescription = t('calculators.voltage-divider-calculator.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.voltage-divider-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.voltage-divider-calculator.title')}</h1>
            <p class="page-description">{t('calculators.voltage-divider-calculator.description')}</p>
          </div>
        </div>
