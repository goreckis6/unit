...
export default component$(() => {
  ...
  const calculatorName = t('calculators.voltage-drop-calculator.title');
  const calculatorDescription = t('calculators.voltage-drop-calculator.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.voltage-drop-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.voltage-drop-calculator.title')}</h1>
            <p class="page-description">{t('calculators.voltage-drop-calculator.description')}</p>
          </div>
        </div>
