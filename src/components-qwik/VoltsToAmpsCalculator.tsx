...
export default component$(() => {
  ...
  const calculatorName = t('calculators.volts-to-amps.title');
  const calculatorDescription = t('calculators.volts-to-amps.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.volts-to-amps-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.volts-to-amps-calculator.title')}</h1>
            <p class="page-description">{t('calculators.volts-to-amps-calculator.description')}</p>
          </div>
        </div>
