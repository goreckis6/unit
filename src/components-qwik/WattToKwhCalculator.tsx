...
export default component$(() => {
  ...
  const calculatorName = t('calculators.watt-to-kwh.title');
  const calculatorDescription = t('calculators.watt-to-kwh.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.watt-to-kwh-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.watt-to-kwh-calculator.title')}</h1>
            <p class="page-description">{t('calculators.watt-to-kwh-calculator.description')}</p>
          </div>
        </div>
