...
export default component$(() => {
  ...
  const calculatorName = t('calculators.watts-to-amps.title');
  const calculatorDescription = t('calculators.watts-to-amps.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.watts-to-amps-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.watts-to-amps-calculator.title')}</h1>
            <p class="page-description">{t('calculators.watts-to-amps-calculator.description')}</p>
          </div>
        </div>
