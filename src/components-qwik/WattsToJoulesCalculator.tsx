...
export default component$(() => {
  ...
  const calculatorName = t('calculators.watts-to-joules.title');
  const calculatorDescription = t('calculators.watts-to-joules.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.watts-to-joules-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.watts-to-joules-calculator.title')}</h1>
            <p class="page-description">{t('calculators.watts-to-joules-calculator.description')}</p>
          </div>
        </div>
