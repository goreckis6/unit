...
export default component$(() => {
  ...
  const calculatorName = t('calculators.watts-to-volts.title');
  const calculatorDescription = t('calculators.watts-to-volts.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.watts-to-volts-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.watts-to-volts-calculator.title')}</h1>
            <p class="page-description">{t('calculators.watts-to-volts-calculator.description')}</p>
          </div>
        </div>
