...
export default component$(() => {
  ...
  const calculatorName = t('calculators.watts-volts-amps-ohms-calculator.title');
  const calculatorDescription = t('calculators.watts-volts-amps-ohms-calculator.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.watts-volts-amps-ohms-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.watts-volts-amps-ohms-calculator.title')}</h1>
            <p class="page-description">{t('calculators.watts-volts-amps-ohms-calculator.description')}</p>
          </div>
        </div>
