...
export default component$(() => {
  ...
  const calculatorName = t('calculators.wh-to-mah.title');
  const calculatorDescription = t('calculators.wh-to-mah.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.wh-to-mah-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.wh-to-mah-calculator.title')}</h1>
            <p class="page-description">{t('calculators.wh-to-mah-calculator.description')}</p>
          </div>
        </div>
