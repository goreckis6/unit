...
export default component$(() => {
  ...
  const calculatorName = t('calculators.wire-gauge-calculator.title');
  const calculatorDescription = t('calculators.wire-gauge-calculator.seo.description');
      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.wire-gauge-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.wire-gauge-calculator.title')}</h1>
            <p class="page-description">{t('calculators.wire-gauge-calculator.description')}</p>
          </div>
        </div>
