      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.antilog-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.antilog-calculator.title')}</h1>
            <p class="page-description">{t('calculators.antilog-calculator.description')}</p>
          </div>
        </div>
