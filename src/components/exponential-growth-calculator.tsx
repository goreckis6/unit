      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.exponential-growth-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.exponential-growth-calculator.title')}</h1>
            <p class="page-description">{t('calculators.exponential-growth-calculator.description')}</p>
          </div>
        </div>
