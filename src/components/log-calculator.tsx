      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.log-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.log-calculator.title')}</h1>
            <p class="page-description">{t('calculators.log-calculator.description')}</p>
          </div>
        </div>
