      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.ratio-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.ratio-calculator.title')}</h1>
            <p class="page-description">{t('calculators.ratio-calculator.description')}</p>
          </div>
        </div>
