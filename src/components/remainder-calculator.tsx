      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.remainder-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.remainder-calculator.title')}</h1>
            <p class="page-description">{t('calculators.remainder-calculator.description')}</p>
          </div>
        </div>
