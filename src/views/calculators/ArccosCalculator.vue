          ...
          <transition name="slide-up">
            <div v-if="result !== null" class="result-section">
              ...
              <div class="result-display">
                <div class="arccos-result">
                  <div class="result-formula">
                    <span class="formula-text">arccos({{ inputValue }})</span>
                ...
                <div v-if="angleInfo" class="angle-info-box">
                  ...
                  <div class="info-row">
                    <span class="info-label">{{ $t('calculators.arccos.angleDegrees') }}:</span>
                    <span class="info-value">{{ angleInfo.angleDegrees.toFixed(6) }}°</span>
                  </div>
                  <div class="info-row">
                    <span class="info-label">{{ $t('calculators.arccos.angleRadians') }}:</span>
...
export default {
  ...
  methods: {
    updateMetaTags() {
      ...
      document.title = this.$t('calculators.arccos.seo.title')
      ...
      metaDescription.setAttribute('content', this.$t('calculators.arccos.seo.description'))
      ...
      metaKeywords.setAttribute('content', this.$t('calculators.arccos.seo.keywords'))
    ...
    updateOpenGraph() {
      ...
      ogTitle.setAttribute('content', this.$t('calculators.arccos.seo.title'))
      ...
      ogDescription.setAttribute('content', this.$t('calculators.arccos.seo.description'))
    ...
    validateInput() {
      ...
      if (this.inputValue !== null && this.inputValue !== '') {
        if (this.inputValue < -1 || this.inputValue > 1) {
          this.error = this.$t('calculators.arccos.error.outOfRange')
        }
      }
    },
    calculate() {
      ...
      if (this.inputValue === null || this.inputValue === '') {
        this.error = this.$t('calculators.arccos.error.invalidInput')
        return
      }
      ...
      const resultInRadians = Math.acos(this.inputValue)
