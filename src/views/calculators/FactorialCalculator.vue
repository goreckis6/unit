...
export default {
  ...
  computed: {
    canCalculate() {
      return this.number !== null && this.number !== '' && this.number >= 0 && Number.isInteger(this.number)
    }
  },
  mounted() {
    this.updateMetaTags()
  ...
  methods: {
    calculate() {
      ...
      if (num < 0) {
        this.errorMessage = this.$t('calculators.factorial.errorNegative')
        this.result = null
        return
      }
      
      if (!Number.isInteger(num)) {
        this.errorMessage = this.$t('calculators.factorial.errorDecimal')
        this.result = null
        return
      }
    ...
    updateMetaTags() {
      ...
      document.title = this.$t('calculators.factorial.seo.title')
      ...
      metaDescription.setAttribute('content', this.$t('calculators.factorial.seo.description'))
      ...
      metaKeywords.setAttribute('content', this.$t('calculators.factorial.seo.keywords'))
