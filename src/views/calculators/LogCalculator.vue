            ...
            <div v-if="result !== null" class="result-section">
              ...
              <div class="result-display">
                <div class="log-result">
                  <div class="result-formula">
                    <span class="formula-text">log₁₀({{ inputValue }})</span>
              ...
              <div v-if="result !== null" class="info-section">
                <div class="info-card">
                  ...
                  <div class="info-item">
                    <span class="info-label">{{ $t('calculators.log.tenRaisedTo') }}:</span>
                    <span class="info-value">10^{{ formatResult(result) }} ≈ {{ Math.pow(10, result).toFixed(10) }}</span>
                  </div>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    updateMetaTags() {
      ...
      document.title = this.$t('calculators.log.seo.title')
      ...
      metaDescription.setAttribute('content', this.$t('calculators.log.seo.description'))
      ...
      metaKeywords.setAttribute('content', this.$t('calculators.log.seo.keywords'))
    ...
    updateOpenGraph() {
      ...
      ogTitle.setAttribute('content', this.$t('calculators.log.seo.title'))
      ...
      ogDescription.setAttribute('content', this.$t('calculators.log.seo.description'))
    ...
    validateInput() {
      ...
      if (this.inputValue !== null && this.inputValue !== '') {
        if (this.inputValue <= 0) {
          this.error = this.$t('calculators.log.error.positiveOnly')
          return
        }
      }
    },
    calculate() {
      ...
      if (this.inputValue === null || this.inputValue === '') {
        this.error = this.$t('calculators.log.error.invalidInput')
        return
      }
      ...
      this.result = Math.log10(this.inputValue)
    },
    clear() {
