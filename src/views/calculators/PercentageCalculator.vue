              ...
              <div class="result-display">
                ...
                <div class="result-formula-large">
                  <div class="formula-number-box">
                    <span class="formula-number-value">{{ formatNumber(percentage) }}%</span>
                  </div>
                  <div class="formula-operator-box">
                    <span class="formula-operator-symbol">{{ $t('calculators.percentage.of') }}</span>
                  </div>
                  <div class="formula-number-box">
                    <span class="formula-number-value">{{ formatNumber(number) }}</span>
                  </div>
...
export default {
  ...
  methods: {
    calculate() {
      ...
      const percent = parseFloat(this.percentage) || 0
      const num = parseFloat(this.number) || 0
      
      this.result = (percent / 100) * num
    },
    clear() {
    ...
    updateMetaTags() {
      ...
      document.title = this.$t('calculators.percentage.seo.title')
      ...
      metaDescription.setAttribute('content', this.$t('calculators.percentage.seo.description'))
      ...
      metaKeywords.setAttribute('content', this.$t('calculators.percentage.seo.keywords'))
    ...
    updateOpenGraph() {
      ...
      ogTitle.setAttribute('content', this.$t('calculators.percentage.seo.title'))
      ...
      ogDescription.setAttribute('content', this.$t('calculators.percentage.seo.description'))
