    ...
    <div class="container">
      <div class="calculator-header">
        ...
        <div class="header-content">
          <div class="title-badge">{{ $t('calculators.powerCalculator.badge') }}</div>
          <h1 class="page-title">{{ $t('calculators.powerCalculator.title') }}</h1>
          <p class="page-description">{{ $t('calculators.powerCalculator.description') }}</p>
        </div>
      </div>
      ...
      <div class="calculator-container">
          ...
          <div class="input-section">
            <div class="inputs-grid">
              ...
              <div class="input-card">
                <label class="input-label">{{ $t('calculators.powerCalculator.resistanceLabel') }}</label>
                <div class="input-with-unit">
                  <input
                    v-model.number="resistanceValue"
                    type="number"
                    class="number-input"
                    :placeholder="$t('calculators.powerCalculator.resistancePlaceholder')"
                    @input="validateInput"
              ...
              <!-- Current Input -->
              <div class="input-card">
                <label class="input-label">{{ $t('calculators.powerCalculator.currentLabel') }}</label>
                <div class="input-with-unit">
                  <input
                    v-model.number="currentValue"
                    type="number"
                    class="number-input"
                    :placeholder="$t('calculators.powerCalculator.currentPlaceholder')"
                    @input="validateInput"
                    @keyup.enter="calculate"
                    step="any"
                  />
              ...
              <!-- Voltage Input -->
              <div class="input-card">
                <label class="input-label">{{ $t('calculators.powerCalculator.voltageLabel') }}</label>
                <div class="input-with-unit">
                  <input
                    v-model.number="voltageValue"
                    type="number"
                    class="number-input"
                    :placeholder="$t('calculators.powerCalculator.voltagePlaceholder')"
                    @input="validateInput"
                    @keyup.enter="calculate"
                    step="any"
                  />
              ...
              <!-- Power Input -->
              <div class="input-card">
                <label class="input-label">{{ $t('calculators.powerCalculator.powerLabel') }}</label>
                <div class="input-with-unit">
                  <input
                    v-model.number="powerValue"
                    type="number"
                    class="number-input"
                    :placeholder="$t('calculators.powerCalculator.powerPlaceholder')"
                    @input="validateInput"
                    @keyup.enter="calculate"
                    step="any"
                  />
            ...
            <div v-if="results.length > 0" class="result-section">
              <div class="result-header">
                <div class="result-badge">
                  ...
                  {{ $t('calculators.powerCalculator.result') }}
                </div>
              </div>
              ...
              <div v-if="results.length > 0" class="info-section">
                <div class="info-card">
                  <div class="info-item">
                    <span class="info-label">{{ $t('calculators.powerCalculator.formula') }}:</span>
        ...
        <div class="seo-content-section">
          <div class="seo-content-card">
            <h2 class="seo-heading">{{ $t('calculators.powerCalculator.seo.content.heading') }}</h2>
            
            <div class="seo-paragraphs">
              <p class="seo-paragraph">
                {{ $t('calculators.powerCalculator.seo.content.paragraph1') }}
              </p>
              
              <p class="seo-paragraph">
                {{ $t('calculators.powerCalculator.seo.content.paragraph2') }}
              </p>
              
              <p class="seo-paragraph">
                {{ $t('calculators.powerCalculator.seo.content.paragraph3') }}
              </p>
              
              <div class="seo-example">
                <h3 class="example-heading">{{ $t('calculators.powerCalculator.seo.content.exampleHeading') }}</h3>
                <p class="example-text">{{ $t('calculators.powerCalculator.seo.content.exampleText') }}</p>
              </div>
              
              <p class="seo-paragraph">
                {{ $t('calculators.powerCalculator.seo.content.paragraph4') }}
              </p>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    updateMetaTags() {
      ...
      document.title = this.$t('calculators.powerCalculator.seo.title')
      ...
      metaDescription.setAttribute('content', this.$t('calculators.powerCalculator.seo.description'))
      ...
      metaKeywords.setAttribute('content', this.$t('calculators.powerCalculator.seo.keywords'))
    ...
    updateOpenGraph() {
      ...
      ogTitle.setAttribute('content', this.$t('calculators.powerCalculator.seo.title'))
      ...
      ogDescription.setAttribute('content', this.$t('calculators.powerCalculator.seo.description'))
    ...
    calculate() {
      ...
      if (filled.length !== 2) {
        this.error = this.$t('calculators.powerCalculator.error.needTwoValues')
        return
      }

      // Check for invalid values
      if (filled.some(item => item.value === 0 && (item.name === 'resistance' || item.name === 'current'))) {
        this.error = this.$t('calculators.powerCalculator.error.invalidValues')
        return
      }
      ...
      if (r === null) {
        this.results.push({
          label: this.$t('calculators.powerCalculator.resistanceLabel'),
      ...
      if (i === null) {
        this.results.push({
          label: this.$t('calculators.powerCalculator.currentLabel'),
      ...
      if (v === null) {
        this.results.push({
          label: this.$t('calculators.powerCalculator.voltageLabel'),
      ...
      if (p === null) {
        this.results.push({
          label: this.$t('calculators.powerCalculator.powerLabel'),
