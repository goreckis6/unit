...
export default {
  ...
  methods: {
    ...
    updateMetaTags() {
      ...
      document.title = this.$t('calculators.square.seo.title')
      ...
      metaDescription.setAttribute('content', this.$t('calculators.square.seo.description'))
      ...
      metaKeywords.setAttribute('content', this.$t('calculators.square.seo.keywords'))
    ...
    updateOpenGraph() {
      ...
      ogTitle.setAttribute('content', this.$t('calculators.square.seo.title'))
      ...
      ogDescription.setAttribute('content', this.$t('calculators.square.seo.description'))
