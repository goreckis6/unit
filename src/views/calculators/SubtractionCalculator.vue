...
export default {
  ...
  methods: {
    ...
    updateMetaTags() {
      ...
      document.title = this.$t('calculators.subtraction.seo.title')
      ...
      metaDescription.setAttribute('content', this.$t('calculators.subtraction.seo.description'))
      ...
      metaKeywords.setAttribute('content', this.$t('calculators.subtraction.seo.keywords'))
    ...
    updateOpenGraph() {
      ...
      ogTitle.setAttribute('content', this.$t('calculators.subtraction.seo.title'))
      ...
      ogDescription.setAttribute('content', this.$t('calculators.subtraction.seo.description'))
