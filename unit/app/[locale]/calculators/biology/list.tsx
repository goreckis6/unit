  ...
  return (
    <>
      <CalculatorSearch 
        ...
        placeholder={t('biologyCalculators.searchPlaceholder') || 'Search calculators...'}
        resultsText={t('biologyCalculators.resultsFound') || 'results found'}
        noResultsText={t('biologyCalculators.noResults') || 'No results found'}
        noResultsHint={t('biologyCalculators.tryDifferentSearch') || 'Try a different search term'}
      />
      ...
      <div className="calculators-list">
        ...
        {filteredCalculators.length === 0 && (
          <div className="no-results">
            ...
            <p className="no-results-text">{t('biologyCalculators.noResults') || 'No results found'}</p>
            <p className="no-results-hint">{t('biologyCalculators.tryDifferentSearch') || 'Try a different search term'}</p>
          </div>
        )}
      </div>
    </>
