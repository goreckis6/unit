  ...
  return (
    <>
      <CalculatorSearch 
        ...
        placeholder={t('chemistryCalculators.searchPlaceholder') || 'Search calculators...'}
        resultsText={t('chemistryCalculators.resultsFound') || 'results found'}
        noResultsText={t('chemistryCalculators.noResults') || 'No results found'}
        noResultsHint={t('chemistryCalculators.tryDifferentSearch') || 'Try a different search term'}
      />
      ...
      <div className="calculators-list">
        ...
        {filteredCalculators.length === 0 && (
          <div className="no-results">
            ...
            <p className="no-results-text">{t('chemistryCalculators.noResults') || 'No results found'}</p>
            <p className="no-results-hint">{t('chemistryCalculators.tryDifferentSearch') || 'Try a different search term'}</p>
          </div>
        )}
      </div>
    </>
