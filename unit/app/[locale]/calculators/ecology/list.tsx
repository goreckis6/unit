  ...
  return (
    <>
      <CalculatorSearch 
        ...
        placeholder={t('ecologyCalculators.searchPlaceholder') || 'Search calculators...'}
        resultsText={t('ecologyCalculators.resultsFound') || 'results found'}
        noResultsText={t('ecologyCalculators.noResults') || 'No results found'}
        noResultsHint={t('ecologyCalculators.tryDifferentSearch') || 'Try a different search term'}
      />
      ...
      <div className="calculators-list">
        ...
        {filteredCalculators.length === 0 && (
          <div className="no-results">
            ...
            <p className="no-results-text">{t('ecologyCalculators.noResults') || 'No results found'}</p>
            <p className="no-results-hint">{t('ecologyCalculators.tryDifferentSearch') || 'Try a different search term'}</p>
          </div>
        )}
      </div>
    </>
