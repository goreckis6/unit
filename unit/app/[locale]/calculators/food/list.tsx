  ...
  return (
    <>
      <CalculatorSearch 
        ...
        placeholder={t('foodCalculators.searchPlaceholder') || 'Search calculators...'}
        resultsText={t('foodCalculators.resultsFound') || 'results found'}
        noResultsText={t('foodCalculators.noResults') || 'No results found'}
        noResultsHint={t('foodCalculators.tryDifferentSearch') || 'Try a different search term'}
      />
      ...
      <div className="calculators-list">
        ...
        {filteredCalculators.length === 0 && (
          <div className="no-results">
            ...
            <p className="no-results-text">{t('foodCalculators.noResults') || 'No results found'}</p>
            <p className="no-results-hint">{t('foodCalculators.tryDifferentSearch') || 'Try a different search term'}</p>
          </div>
        )}
      </div>
    </>
