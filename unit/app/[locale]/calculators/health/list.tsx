  ...
  return (
    <>
      <CalculatorSearch 
        ...
        placeholder={t('healthCalculators.searchPlaceholder') || 'Search calculators...'}
        resultsText={t('healthCalculators.resultsFound') || 'results found'}
        noResultsText={t('healthCalculators.noResults') || 'No results found'}
        noResultsHint={t('healthCalculators.tryDifferentSearch') || 'Try a different search term'}
      />
      ...
      <div className="calculators-list">
        ...
        {filteredCalculators.length === 0 && (
          <div className="no-results">
            ...
            <p className="no-results-text">{t('healthCalculators.noResults') || 'No results found'}</p>
            <p className="no-results-hint">{t('healthCalculators.tryDifferentSearch') || 'Try a different search term'}</p>
          </div>
        )}
      </div>
    </>
