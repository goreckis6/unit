      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.long-multiplication-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.long-multiplication-calculator.title')}</h1>
            <p class="page-description">{t('calculators.long-multiplication-calculator.description')}</p>
          </div>
        </div>
