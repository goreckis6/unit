      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.square-root-calculator.badge')}</div>
            <h1 class="page-title">{t('calculators.square-root-calculator.title')}</h1>
            <p class="page-description">{t('calculators.square-root-calculator.description')}</p>
          </div>
        </div>
