      ...
      <div class="container">
        <div class="calculator-header">
          <div class="header-content">
            <div class="title-badge">{t('calculators.math-calculators.badge')}</div>
            <h1 class="page-title">{t('calculators.math-calculators.title')}</h1>
            <p class="page-description">{t('calculators.math-calculators.description')}</p>
          </div>
        </div>
