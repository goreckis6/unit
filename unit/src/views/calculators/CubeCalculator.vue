    ...
    <div class="container">
      <div class="calculator-header">
        ...
        <div class="header-content">
          <div class="title-badge">{{ $t('calculators.cube.badge') }}</div>
          <h1 class="page-title">{{ $t('calculators.cube.title') }}</h1>
          <p class="page-description">{{ $t('calculators.cube.description') }}</p>
        </div>
      </div>
      ...
      <div class="calculator-container">
            ...
            <div class="cube-row">
              ...
              <div class="number-card">
                <div class="number-card-header">
                  ...
                  <label class="number-label">{{ $t('calculators.cube.number') }}</label>
                </div>
                <input
                  v-model.number="number"
                  type="number"
                  class="number-input-large"
                  :placeholder="$t('calculators.cube.enterNumber')"
                  @input="calculate"
        ...
        <div class="seo-content-section">
          <div class="seo-content-card">
            <h2 class="seo-heading">{{ $t('calculators.cube.seo.content.heading') }}</h2>
            
            <div class="seo-paragraphs">
              <p class="seo-paragraph">
                {{ $t('calculators.cube.seo.content.paragraph1') }}
              </p>
              
              <p class="seo-paragraph">
                {{ $t('calculators.cube.seo.content.paragraph2') }}
              </p>
              
              <p class="seo-paragraph">
                {{ $t('calculators.cube.seo.content.paragraph3') }}
              </p>
              
              <div class="seo-example">
                <h3 class="example-heading">{{ $t('calculators.cube.seo.content.exampleHeading') }}</h3>
                <p class="example-text">{{ $t('calculators.cube.seo.content.exampleText') }}</p>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    updateMetaTags() {
      ...
      document.title = this.$t('calculators.cube.seo.title')
      ...
      metaDescription.setAttribute('content', this.$t('calculators.cube.seo.description'))
      ...
      metaKeywords.setAttribute('content', this.$t('calculators.cube.seo.keywords'))
    ...
    updateOpenGraph() {
      ...
      ogTitle.setAttribute('content', this.$t('calculators.cube.seo.title'))
      ...
      ogDescription.setAttribute('content', this.$t('calculators.cube.seo.description'))
